...
@Component({
  selector: 'app-verificar-user-recovery',
  templateUrl: './verificar-user-recovery.component.html',
  styleUrls: ['./verificar-user-recovery.component.css']
})
export class VerificarUserRecoveryComponent {
  digits: string[] = ['', '', '', '', ''];
  cedula: string = '';
